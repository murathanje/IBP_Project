  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img class="d-inline-block" src="{{ asset('assets') }}/img/gallery/logo.png" width="50" alt="logo" /><span class="fw-bold text-primary ms-2">Götür</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form>
              <button class="btn text-800 order-1 order-lg-0 me-2" type="button">Sign In</button>
              <button class="btn btn-voyage-outline order-0" type="submit"><span class="text-primary">Sign Up</span></button>
            </form>
          </div>
        </div>
      </nav>
