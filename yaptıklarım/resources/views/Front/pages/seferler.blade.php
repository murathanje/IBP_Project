                    ...
                    <div class="col-md-12 mb-4 ">
                        <div class="card ">
                            <div class="card-body align-middle ">
                                <div class="row ">
                                    <div class="col-md-2">
                                        <img src="firma_logo.png" alt="Firma Logo" class="img-fluid">
                                    </div>

                                    <div class="col-md-3 align-middle">
                                        <h5>{{ $sefer['kalkis'] }} - {{ $sefer['varis'] }}</h5>
                                    </div>
                                    <div class="col-md-2">
                                        <h5>{{ \Carbon\Carbon::parse($sefer['tarih'])->format('d.m.Y') }} <br> {{ $sefer['saat'] }}</h5>
                                    </div>
                                    <div class="col-md-1">
                                        <h5>{{ $sefer['ucret'] }} TL</h5>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="koltukNo">Koltuk No:</label>
                                            <select class="form-control w-auto" id="koltukNo" name="koltukNo">
                                                @for($i = 1; $i <= 36; $i++)
